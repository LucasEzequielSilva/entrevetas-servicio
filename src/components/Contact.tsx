    ...
    <section id="contact" className="py-14 md:py-20 lg:py-24 px-6 md:px-16 bg-foreground overflow-hidden">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.a
          ...
          className="inline-flex items-center gap-3 bg-[#3C6E47] hover:bg-[#345f3e] text-white px-8 py-4 rounded-full text-sm font-medium tracking-widest uppercase transition-colors duration-300"
        >
