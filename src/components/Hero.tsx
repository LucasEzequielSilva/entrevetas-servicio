  ...
  return (
    ...
    >
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-8 md:px-16 py-6 md:py-8">
        <img src={navLogoWhite} alt="Entre Vetas" className="w-[60px] md:w-[80px] h-auto drop-shadow-[0_1px_3px_rgba(0,0,0,0.4)]" />
      ...
      <motion.div className="relative z-10 px-8 md:px-16 max-w-3xl mt-8 md:mt-0" style={{ y: contentY }}>
        <motion.h1
          ...
          className="text-[36px] md:text-[clamp(48px,4.5vw,64px)] text-primary-foreground leading-[1.08] tracking-tight mb-5"
        >
          {t("hero.title")}
        </motion.h1>
        <motion.p
