...
import logoEV from "@/assets/logo-ev-white.png";
...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-[85vh] md:min-h-screen flex items-end pb-16 md:pb-32 overflow-hidden p-4 md:p-6">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-6 md:px-16 py-[21px]">
        <motion.a
          href="/"
