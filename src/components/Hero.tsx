...
const Hero = () => {
  ...
  return (
    <section
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-6 md:px-16 py-[22px]">
        <motion.img
          src={navLogo}
          alt="Entre Vetas"
      ...
      <motion.div className="relative z-10 px-6 md:px-16 max-w-4xl pb-[30px]" style={{ y: contentY }}>
        <motion.div
          initial={{ width: 0 }}
          animate={{ width: 60 }}
